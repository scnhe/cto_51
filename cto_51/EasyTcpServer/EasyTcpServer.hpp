...
public:
...
#ifdef _WIN32
		SOCKET _clientSock = accept(_sock, (sockaddr *)&_client, &nAddrLen);
#else
		SOCKET _clientSock = accept(_sock, (sockaddr *)&_client, (socklen_t *)&nAddrLen);
#endif
	...
	virtual void OnNetMsg(SOCKET _cSock,DataHeader *header)
	{
		...
		case CMD_LOGIN:
		{
			Login *login = NULL;			
			login = (Login*)header;
			std::cout << _cSock << " 接收到登陆命令:" << "UserName: " << login->userName << std::endl;
